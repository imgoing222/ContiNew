...
const useForm = ({ initialValues, onSubmit }: Props) => {
	...
	const handleGoogleLoginClick = () => {
		window.location.href = `https://accounts.google.com/o/oauth2/v2/auth?client_id=1061218236894-vsgtu6jnm857eede27uae3cfesp9kha9.apps.googleusercontent.com&response_type=code&redirect_uri=https://k6d105.p.ssafy.io/login/oauth2/code/google&scope=https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile`;
	};
