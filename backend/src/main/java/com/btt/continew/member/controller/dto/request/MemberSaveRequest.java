...
public class MemberSaveRequest {
    ...
    @ApiModelProperty(position = 0, notes = "로그인 아이디", example = "continew")
    @JsonProperty("login_id")
    private String loginId;

    @ApiModelProperty(position = 1, notes = "비밀번호", example = "Zjsxlsb123!!")
    @JsonProperty("password")
    private String password;

    @ApiModelProperty(position = 2, notes = "닉네임", example = "컨티뉴")
