...
public enum ErrorCode {
    ...
    CONTRACT_ALREADY_AGREE(HttpStatus.BAD_REQUEST, "이미 계약 수락한 회원입니다.", "K04"),
    CONTRACT_NOT_FOUND_CONTRACT_AGREE(HttpStatus.NOT_FOUND, "계약 시작 요청을 찾을 수 없습니다.", "K05"),
    CONTRACT_NOT_YOUR_CONTRACT_AGREE(HttpStatus.BAD_REQUEST, "당신의 계약 요청이 아닙니다.", "K06"),
    CONTRACT_ALREADY_COMPLETED_AGREE(HttpStatus.BAD_REQUEST, "이미 끝난 요청입니다.", "K07"),
